...
<a target="_blank" href="https://docs.couchbase.com/c-sdk/current/howtos/kv-operations.html">C/C++ Key Value Operations</a>.
*/
...
main()
{
    ...
    std::vector<std::string> keys_to_get{ "airline_10" };
